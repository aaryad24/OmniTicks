...
// Handler to add date and time selection
...
// Handler to remove a specific time from a date
...
const handleSubmit = async () =>{
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <p className="text-lg font-medium mt-10">Now Playing Movies</p>
          ...
          <div className="flex flex-wrap gap-2 mt-1 text-sm">
            {times.map((time) => (
              <div key={time} className="border border-primary px-2 py-1 flex items-center rounded">
                <span>{time}</span>
                {/* Replace with your delete icon, e.g., an 'X' or a proper icon component */}
                <DeleteIcon
